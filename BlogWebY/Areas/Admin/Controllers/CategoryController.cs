...
namespace BlogWebY.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> AddWithAjax([FromBody] CategoryAddDto categoryAddDto)
        {
            ...
            {
                toast.AddErrorToastMessage(result.Errors.First().ErrorMessage, new ToastrOptions { Title = "Islem Basarisiz" });
        ...
        public async Task<IActionResult> Update(CategoryUpdateDto categoryUpdateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                toast.AddSuccessToastMessage(Messages.Category.Update(name), new ToastrOptions { Title = "Basarili" });
                return RedirectToAction("Index", "Category", new { Area = "Admin" });
...
//    toast.AddSuccessToastMessage(Messages.Article.Add(articleAddDto.Title), new ToastrOptions { Title = "Basarili" });
